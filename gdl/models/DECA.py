...
class DecaModule(LightningModule):
    ...
    def encode(self, batch, training=True) -> dict:
        ...
        # images = batch['image']
        images = batch if isinstance(batch, torch.Tensor) else batch['image']
