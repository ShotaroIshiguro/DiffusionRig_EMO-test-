...
"""
EmotioNetデータセット内の画像データを指定URLからダウンロードし、顔の感情に関する特徴をデータ化
"""
...
# 指定されたインデックスのtxtファイルを読み込み、URLリストと感情特徴を含むデータフレームを作成
